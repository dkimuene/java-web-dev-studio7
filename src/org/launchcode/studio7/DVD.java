...
public class DVD extends BaseDisc implements OpticalDisc{
    ...
    public DVD(String name, String releaseDate, double capacity, String discType, int minSpeed, int maxSpeed) {
        super(name, releaseDate, capacity, discType, minSpeed, maxSpeed);
    }

    @Override
    public void spinDisc() {
        System.out.println("A DVD spins at a rate of "+this.getMinSpeed() + " - "+getMaxSpeed());
    }
